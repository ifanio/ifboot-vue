<template>
  <div class="app-container">
    ...
    <el-table :data="tableData">
      ...
      <el-table-column label="类型" prop="type" width />
      <el-table-column label="图标" prop="icon" width />
      <el-table-column label="路由" prop="router" width />
      <el-table-column label="组件" prop="component" width />
      <el-table-column label="权限" prop="authority" width />
      <el-table-column label="启用" prop="enable" width :formatter="formatter1" />
      <el-table-column label="时间" prop="date" width />
